...
import com.chinatelecom.dialoglibrary.widget.internal.BaseAlertDialog;
...
public class MaterialDialog extends BaseAlertDialog<MaterialDialog> {
    ...
    public MaterialDialog(Context context) {
        ...
        leftBtnTextColor = Color.parseColor("#ff2d55");
        rightBtnTextColor = Color.parseColor("#ff2d55");
        middleBtnTextColor = Color.parseColor("#ff2d55");
        /** default value*/
    }

    @Override
    public View onCreateView() {
        ll_container.setGravity(Gravity.CENTER_HORIZONTAL);
        /** title */
        tv_title.setGravity(Gravity.CENTER_VERTICAL|Gravity.CENTER_HORIZONTAL);
