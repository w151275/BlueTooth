package com.chinatelecom.dialoglibrary.widget;
...
import com.chinatelecom.dialoglibrary.entity.DialogMenuItem;
import com.chinatelecom.dialoglibrary.listener.OnOperItemClickL;
import com.chinatelecom.dialoglibrary.utils.CornerUtils;
import com.chinatelecom.dialoglibrary.widget.base.BottomBaseDialog;
...
public class ActionSheetDialog extends BottomBaseDialog {
     ...
     */
    private int itemTextColor = Color.parseColor("#242424");

    /**
     * item 取消按钮的颜色
     */
    private int itemCancelColor = Color.parseColor("#242424");
    /**
    ...
    public void setTvCancelOnClickListener(View.OnClickListener onClickListener){
        this.tvCancelOnClickListener=onClickListener;
    }
    ...
    public void setUiBeforShow() {
        ...
        tv_cancel.setOnClickListener(tvCancelOnClickListener!=null?tvCancelOnClickListener:new View.OnClickListener() {
            @Override
